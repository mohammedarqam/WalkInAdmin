...
@IonicPage()
@Component({
  selector: 'page-play-zone-details',
  templateUrl: 'play-zone-details.html',
})
export class PlayZoneDetailsPage {
  ...
  public playZone = this.navParams.get("playZone");
  ...
  getpartner(){
    firebase.database().ref("PartnerAdmins").child(this.playZone.AdminId).once('value',itemSnap=>{
